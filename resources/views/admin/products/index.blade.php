...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0" style="color:var(--text);">
            <i class="bi bi-cpu me-2" style="color:var(--primary);"></i>Data Produk
        </h4>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead style="background:var(--surface-2);">
                            <tr style="border-color:var(--border);">
                                <th width="50" style="color:var(--text-muted);font-size:.78rem;font-weight:600;">#</th>
                                <th width="80" style="color:var(--text-muted);font-size:.78rem;font-weight:600;">Foto
                                </th>
                                <th style="color:var(--text-muted);font-size:.78rem;font-weight:600;">Nama Produk</th>
                                ...
                                <th class="text-center" style="color:var(--text-muted);font-size:.78rem;font-weight:600;">
                                    Stok</th>
                        ...
                        <tbody>
                            @foreach ($products as $i => $product)
                                <tr style="border-color:var(--border);">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.products.edit', $product) }}" class="btn btn-sm me-1"
