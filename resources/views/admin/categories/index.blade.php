        ...
        <div class="card-body p-0">
            @if ($categories->isEmpty())
                <div class="text-center py-5" style="color:var(--text-muted);">
                    ...
                    <p class="mt-2 mb-0">Belum ada kategori. Tambahkan sekarang!</p>
                </div>
            @else
                <table class="table table-hover mb-0">
                    <thead style="background:var(--surface-2);">
                        <tr style="border-color:var(--border);">
                            <th width="60" style="color:var(--text-muted);font-size:.78rem;font-weight:600;">#</th>
                            <th style="color:var(--text-muted);font-size:.78rem;font-weight:600;">Nama Kategori</th>
                            <th class="text-center" style="color:var(--text-muted);font-size:.78rem;font-weight:600;">Jumlah
                                Produk</th>
                            <th class="text-center" style="color:var(--text-muted);font-size:.78rem;font-weight:600;">Dibuat
                            </th>
                    ...
                    <tbody>
                        @foreach ($categories as $i => $cat)
                            <tr style="border-color:var(--border);">
                                <td style="color:var(--text-subtle);font-size:.85rem;">{{ $i + 1 }}</td>
                                <td class="fw-semibold" style="font-size:.875rem;color:var(--text);">{{ $cat->name }}
                                </td>
